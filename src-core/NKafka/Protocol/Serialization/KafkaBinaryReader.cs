...
namespace NKafka.Protocol.Serialization
{
    ...
    public class KafkaBinaryReader : IDisposable
    {
        ...
        public uint EndReadCrc32()
        {
            ...
            var actualCrc32 = KafkaCrc32.Compute(GetBuffer(), beginPosition, endPosition - beginPosition);
        ...
        {            
            ...
            using (var source = new MemoryStream(GetBuffer(), (int)_stream.Position, size))
            {                
