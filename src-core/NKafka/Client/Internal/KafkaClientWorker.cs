...
namespace NKafka.Client.Internal
{
    internal sealed class KafkaClientWorker
    {
            ...
            [CanBeNull] IKafkaClientLogger logger)
        {
            ...
            _workerTimer = new Timer(Work, null, Timeout.InfiniteTimeSpan, Timeout.InfiniteTimeSpan);
        }
        ...
        {            
            _workerCancellation = new CancellationTokenSource();
            var produceTimer = new Timer(Work, null, Timeout.InfiniteTimeSpan, Timeout.InfiniteTimeSpan);
