...
{    
    internal sealed class KafkaCoordinatorGroupMemberAssignmentData
    {
        ...
        public KafkaCoordinatorGroupMemberAssignmentData([NotNull] string memberId, bool isLeader, short protocolVersion, 
